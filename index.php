...
class CONFIG
{
    ...
    const MAX_FILEAGE = 9999; //max. age of files in days
    const MIN_FILEAGE = 990; //min. age of files in days
    ...
    const STORE_PATH = ''; //directory to store uploaded files in
    ...
    const ADMIN_EMAIL = 'leopold@exohost.fr';  //address for inquiries
...
<html lang="en">
<head>
    <title>CDN Dekam</title>
    <meta name="description" content="File host service" />
